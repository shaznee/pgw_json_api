...
public class ShipToAddress {
	...
	/**
	 * @param customer_number Purchase order or other number used by merchant’s customer to track the order.
	 * @return {@link #ShipToAddress}
	 */
	...
	/**
	 * @param email The Accountholder’s email address associated with the transaction. 
	 * @return {@link #ShipToAddress}
	 */
	...
	/**
	 * @param name The Accountholder’s name associated with the transaction. 
	...
	/**
	 * @param phone The Accountholder’s phone number associated with the transaction. 
