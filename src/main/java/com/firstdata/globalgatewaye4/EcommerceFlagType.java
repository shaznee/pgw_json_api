...
public class EcommerceFlagType {
	...
	/**
	 * <p>Retail Indicator – designates a transaction where the cardholder was present at a merchant location.</p>
	 * <p>If an “R” is sent for a transaction with a MOTO Merchant Category Code (MCC) the transaction will downgrade.</p>
	 */
